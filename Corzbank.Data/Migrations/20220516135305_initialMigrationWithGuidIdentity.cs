...
{
    public partial class initialMigrationWithGuidIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExchangeCurrency = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiverCardId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositOpened = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderCardId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReceiverCardId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransferCards", x => new { x.TransferId, x.SenderCardId, x.ReceiverCardId });
                    table.ForeignKey(
                        name: "FK_TransferCards_Cards_ReceiverCardId",
                        column: x => x.ReceiverCardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferCards_Cards_SenderCardId",
                        column: x => x.SenderCardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransferCards_Transfers_TransferId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepositCards", x => new { x.CardId, x.DepositId });
                    table.ForeignKey(
                        name: "FK_DepositCards_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepositCards_Deposits_DepositId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepositCards_DepositId",
                table: "DepositCards",
                column: "DepositId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransferCards_ReceiverCardId",
                table: "TransferCards",
                column: "ReceiverCardId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferCards_SenderCardId",
                table: "TransferCards",
                column: "SenderCardId");
